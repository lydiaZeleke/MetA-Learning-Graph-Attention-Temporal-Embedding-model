...
def get_parser():
    ...
    parser.add_argument("--tcn_kernel_size", type=int, default = 5) #higher kernel size can help increase teh receptive field 

    # GRU layers
    parser.add_argument("--gru_num_layers", type=int, default=3)
    parser.add_argument("--gru_hidden_dim", type=int, default=150)
    ...
    parser.add_argument("--num_memory_slots", type=int, default= 16)
    parser.add_argument("--node_embed_dim", type=int, default = 100) # node embedding made to match the window size for our current architectural setup
    ...
    parser.add_argument("--bs", type=int, default=256) #256
